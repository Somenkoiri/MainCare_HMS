...
<body>
    ...
    <div class="form-container">
        ...
        <form id="medicineForm" action="" method="post">
            ...
            <input type="date" id="expirationEnd" name="expirationEnd" required>
...
$sqli = "INSERT INTO `medicine_db`(`Medicine_Name`, `Purchase_Date`, `Expiration_Date`, `Expiration_End`, `Price_user`, `Quantity_user`) VALUES ('$MedicineName','$PurchaseDate','$ExpirationDate','$ExpirationEnd','$Price','$Quantity')";

$data = mysqli_query($conn,$sqli);

if ($data) {
    
     echo "<script>alert('( Thank You! Add Your Medicine !! )')</script>";
}
else
{
     echo "<script>alert('( Sorry! No Inset Medicine !! )')</script>";
}
